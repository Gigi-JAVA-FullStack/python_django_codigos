...
## para referência futura ou para recomecar o jogo, se for o desejo do jogador (usuario).
   ...
   # Prompt para usuario escolher entre uma palavra da LISTA existe ou inserir nova palavra.
    print('\n+++++++++++++++++++++++++++++++++++++')
    ...
    if escolha_jogar == '1':
        ...
        print("Invalido. Por favor, digite apenas 1 ou 2, tente novamente e vamos jogar...")
        return
